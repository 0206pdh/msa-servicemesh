...
> 실제 YAML/Helm 설정을 한 줄씩 이해하고 싶다면
> [docs/infrastructure-deep-dive.md](docs/infrastructure-deep-dive.md)를 참고한다.
...
| 개념 | [핵심 개념과 용어](docs/03-concepts-and-glossary.md), [무엇을 왜 테스트했는가](docs/testing-explained.md), [인프라 YAML 완전 정복](docs/infrastructure-deep-dive.md) |
