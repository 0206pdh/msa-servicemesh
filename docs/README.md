...
2. [범위와 성공 기준](01-scope-and-success-criteria.md)
3. [전체 아키텍처](02-architecture.md)
4. [Benchmark Workload](application/README.md)
5. [전체 Phase](phases/README.md)
...
문서는 계획·구현·검증·측정을 구분하며, 모든 성능 결론은 raw result와 환경 범위를 연결한다.
